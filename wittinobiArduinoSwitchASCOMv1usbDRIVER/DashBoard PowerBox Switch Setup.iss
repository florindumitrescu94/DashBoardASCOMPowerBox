...
; Generated by flo on 1/26/2024 (UTC)
;
[Setup]
AppID={{07c8b786-1d8e-42b7-9a3e-a3316af22078}
AppName=ASCOM DashBoard PowerBox Switch Switch Driver
AppVerName=ASCOM DashBoard PowerBox Switch Switch Driver 1.0.5
AppVersion=1.0.5
...
OutputDir="."
OutputBaseFilename="DashBoard PowerBox Switch Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\DashBoard PowerBox Switch"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\DashBoard PowerBox Switch"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "E:\VisualStudioProjects\Dashboard_2\wittinobiArduinoSwitchASCOMv1usb-master\wittinobiArduinoSwitchASCOMv1usbDRIVER\bin\Release\ASCOM.wittinobiArduinoSwitchASCOMv1usbDRIVER.Switch.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "E:\VisualStudioProjects\Dashboard_2\wittinobiArduinoSwitchASCOMv1usb-master\wittinobiArduinoSwitchASCOMv1usbDRIVER\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.wittinobiArduinoSwitchASCOMv1usbDRIVER.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.wittinobiArduinoSwitchASCOMv1usbDRIVER.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.wittinobiArduinoSwitchASCOMv1usbDRIVER.Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.wittinobiArduinoSwitchASCOMv1usbDRIVER.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.wittinobiArduinoSwitchASCOMv1usbDRIVER.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
